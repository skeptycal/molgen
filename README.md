...
![GitHub Workflow Status](https://img.shields.io/github/workflow/status/skeptycal/molgen/Go) ![Codecov](https://img.shields.io/codecov/c/github/skeptycal/molgen)
...
```sh
gh repo create -y --public --template "https://github.com/skeptycal/molgen"
```
...
go get github.com/xxxxxx/molgen

cd ${GOPATH}/src/github.com/xxxxxx/molgen
...
> This is a copy of the example script available in the `cmd/example/molgen` folder:

```go
package main

import "github.com/skeptycal/molgen"
...
[issues]: (https://github.com/skeptycal/molgen/issues)
[pr]: (https://github.com/skeptycal/molgen/pulls)
